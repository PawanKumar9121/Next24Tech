export const items =  [
   ...
   },
   {
      ...
      imgSrc: 'https://m.media-amazon.com/images/I/81DysDLNKML._SX569_.jpg',
      amazonLink: 'https://amzn.to/3r9rvhm',
      description: 'Apple MacBook Air Laptop M1 chip, 13.3-inch/33.74 cm Retina Display, ',
      price: '599',
    },
   {
      ...
      imgSrc: 'https://m.media-amazon.com/images/I/51JIlfNvLGL._SY741_.jpg',
      amazonLink: 'https://amzn.to/3r9rvhm',
      description: 'Apple MacBook Air Laptop M1 chip, 13.3-inch/33.74 cm Retina Display, ',
      price: '599',
    },
    {
      id: 12,
      category: 'Fashion',
      title: "Jack and Jini Formal Pant with Expandable Waist for Men. Regular Fit, Flat Front, Premium Lycra Fabric for Office, Party and Casual Wear",
      imgSrc: 'https://m.media-amazon.com/images/I/51l+RD4ibBL._SY741_.jpg',
      amazonLink: 'https://amzn.to/3r9rvhm',
      description: 'Apple MacBook Air Laptop M1 chip, 13.3-inch/33.74 cm Retina Display, ',
      price: '599',
    },
